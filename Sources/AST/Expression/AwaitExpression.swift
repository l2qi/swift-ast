...
public class AwaitExpression : ASTNode, ASTExpression {
  ...
  public func replaceExpression(with newExpression: ASTExpression) {
  ...
  override public var textDescription: String {
    return "await \(expression.textDescription)"
  }
}
